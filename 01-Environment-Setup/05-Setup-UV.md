## Setup UV
- Navigate to [UV Documentation](https://docs.astral.sh/uv/getting-started/installation/)
- Install UV by running the command for the standalone installer. You should see a similar output after installation.
  ![UV Installation](/Assets/Images/uv-installation.png)
